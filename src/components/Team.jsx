...
function Team() {
  ...
  const members = [
	  { name: 'MSc. Vũ Văn Thương', info: 'Founder of ZentSoft Software Solutions', background: 'src/assets/Van_Thuong.jpg' },
	  { name: 'MA. Đỗ Thị Thủy', info: 'Marketing and Business Development Expert', background: 'src/assets/Thi_Thuy.png' },
	  { name: 'Prof. Soren Kirchner', info: 'MBA Training Expert - Andrews University', background: 'src/assets/Soren_Kirchner.png' },
    { name: 'Assoc. Prof. Đỗ Hương Lan', info: 'Deputy Director of CSIE - NEU', background: 'src/assets/Huong_Lan.jpg' },
    { name: 'MA. Nguyễn Đức Vinh', info: 'Director of STG', background: 'src/assets/Duc_Vinh.png' },
    { name: 'MA. Trần Văn Lịch', info: 'Director of GGT Vietnam', background: 'src/assets/Van_Lich.png' },
  ];
  ...
  const visibleMembers = isSmallScreen && !showAll ? members.slice(0, 3) : members;
	...
	return (
      ...
      {isSmallScreen && (
        <button className="custom-button" onClick={() => setShowAll(!showAll)}>
